  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-28 flex flex-col gap-24 md:gap-32 lg:gap-40 xl:gap-48 w-full lg:pr-0 items-center ">
          {/* BIOGRAPHY CONTAINER */}
          <div className="flex flex-col gap-12 justify-center items-center text-center">
            ...
            <Image
              ...
              width={112}
              height={112}
              className="w-40 h-40 rounded-full object-cover border-[5px] border-white shadow-md"
            />
            {/* BIOGRAPHY TITLE */}
